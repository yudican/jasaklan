                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>general settings</span>
                        </a>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @if ($update_mode)
                        <x-text-field type="text" name="name" label="Name" readonly />
                        @else
                        <x-text-field type="text" name="name" label="Name" />
                        @endif
                        <x-text-field type="text" name="value" label="Value" />
                    </div>
