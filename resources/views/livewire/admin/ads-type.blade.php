<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>ads types</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.ads-type-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} ads types</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="type_name" label="Type Name" />
                        <x-select name="type_action" label="Type Action">
                            <option value="">Select Type Action</option>
