        ...
        <div class="bg-white rounded-lg border border-gray-200 px-4 py-2 border-b my-2 rounded-t-lg flex justify-between">
            ...
            <div>
                <div class="flex gap-4 py-4">
                    <div>
                        <span class="bg-red-100 text-red-800 text-xs md:text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $comment->getSocialMedia() }}</span>
                        <div>
                    ...
                    <div class="my-auto">
                        ...
                        @else
                        <a href="{{ route('viewers.ticket.session', $comment->id) }}" class="text-white px-3 py-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Ambil Tiket
                        </a>
                        @endif
                    </div>
