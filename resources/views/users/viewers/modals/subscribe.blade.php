    ...
    <div class="relative w-full h-full max-w-md p-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-black-900 dark:text-black">Ambil Tiket Subscribe Youtube</h3>
                <p class="mb-4 text-xs text-justify font-medium text-black-900 dark:text-black">Silahkan kunjungi halaman iklan dan lakukan subscribe kemudian screenshot sebagai bukti Anda sudah subscribe. Pastikan button subscribe dan nama akun Anda terlihat dengan jelas pada screenshot.</p>
                <form enctype="multipart/form-data" class="space-y-6" action="{{ route('viewers.ticket.create') }}" method="post">
                    ...
                    <div>
                        <label for="text" class="block mb-2 text-sm font-medium text-black-900">Nama/Judul Iklan</label>
                        <span aria-current="true" class="text-sm text-black-900">
                            {{ $content->title }}
                        </span>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="text" class="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Nama akun YouTube Anda</label>
                        <input type="text" name="account_name" id="text" placeholder="Nama akun Gmail atau YouTube Anda" class="bg-black-50 border border-black-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black-600 dark:border-black-500 dark:placeholder-black-400 dark:text-black" required>
                    </div>
                    <div>
                        <label for="file" class="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Screenshot</label>
