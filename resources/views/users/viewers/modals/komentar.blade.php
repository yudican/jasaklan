        ...
        <div class="relative w-full h-full max-w-md p-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-black-900 dark:text-black">Ambil Tiket Komentar</h3>
                    <p class="mb-4 text-xs text-justify font-medium text-black-900 dark:text-black">Silahkan kunjungi halaman iklan dan lakukan Komentar kemudian screenshot sebagai bukti Anda sudah Komentar. Pastikan button Komentar dan nama akun Anda terlihat dengan jelas pada screenshot.</p>
