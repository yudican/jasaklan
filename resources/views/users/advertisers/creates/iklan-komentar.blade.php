<x-app-layout>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-3">
            ...
            <form action="{{ route('comment.create') }}" method="post" class="w-full  mt-2 col-span-3">
                @csrf
                <div class="w-full px-3 mt-2 max-w-sm">
                    ...
                    <select name="social_media" onchange="getPaket()" id="sosial_media"
                            {{ old('social_media') }} class="w-full border rounded p-2">
                ...
                <div class="w-full px-3 mt-2">
                    ...
                    <input name="title"
                           class="appearance-none block w-full bg-white text-gray-700 border border-black rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                           id="title" type="text" placeholder="" value="{{ old('title') }}">
                </div>
                ...
                <div class="w-full px-3 mt-2 max-w-sm">
                    ...
                    <select name="package_id" id="paket_view" class="w-full border rounded p-2"
                        ...
                        <option value="">Paket Komentar</option>
