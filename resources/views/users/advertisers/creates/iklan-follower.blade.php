            ...
            <div class="col-span-3">
                ...
                <div class="col-span-3 mt-2 bg-red-200  p-4 mx-2 rounded">
                    ...
                    <div class="ml-2 text-sm">
                        Layanan Follow/ikuti ini merupakan layanan real human (100 % tanpa BOT). yang melakukan Follow semuanya adalah member yang terdaftar di Jasaview.com. Saat ini member kami mencapai kurang lebih 600ribu member dan akan terus bertambah.
                    </div>
                </div>
            </div>
            <!-- Session Status -->
            ...
            <form action="{{ route('follow.create') }}" class="w-full  mt-2 col-span-3" method="post">
                ...
                <div class="w-full px-3 mt-2">
                    ...
                    <input name="url"
                        ...
                        id="grid-password" type="text" placeholder="" value="{{ old('url') }}">
                ...
                <div class="w-full px-3 mt-2">
                    ...
                    <input name="account_name"
                        class="appearance-none block w-full bg-white text-gray-700 border border-black rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id="account_name" type="text" placeholder="" value="{{ old('account_name') }}">
                </div>
