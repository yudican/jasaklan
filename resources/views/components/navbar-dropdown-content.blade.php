        ...
        <div class="ml-4 hidden sm:flex sm:items-center sm:ml-6">
            <x-dropdown class="mx-2" align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    <x-dropdown-link :href="route('viewers.view')">
                        {{ __('Lihat Iklan View') }}
                    </x-dropdown-link>

                    {{-- <x-dropdown-link :href="route('viewers.question')"> --}}
                    {{-- {{ __('Lihat Iklan View Questions') }} --}}
                    {{-- </x-dropdown-link> --}}

                    <x-dropdown-link :href="route('viewers.subscribe')">
                        {{ __('Lihat Iklan Subscribe') }}
                    </x-dropdown-link>

                    <x-dropdown-link :href="route('viewers.follow')">
                        {{ __('Lihat Iklan Follow') }}
                    </x-dropdown-link>

                    <x-dropdown-link :href="route('viewers.like')">
                        {{ __('Lihat Iklan Like') }}
                    </x-dropdown-link>

                    <x-dropdown-link :href="route('viewers.komentar')">
                        {{ __('Lihat Iklan Komentar') }}
                    </x-dropdown-link>

                    <x-dropdown-link :href="route('viewers.posting')">
            ...
            <div class="ml-4 hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="mr-4 flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('iklan.view.views')">
                            {{ __('Daftar Iklan View') }}
                        </x-dropdown-link>

                        {{-- <x-dropdown-link :href="route('iklan.view.question')"> --}}
                        {{-- {{ __('Daftar Iklan View Questions') }} --}}
                        {{-- </x-dropdown-link> --}}

                        <x-dropdown-link :href="route('iklan.view.subscribe')">
                            {{ __('Daftar Iklan Subscribe') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('iklan.view.follower')">
                            {{ __('Daftar Iklan Follow') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('iklan.view.like')">
                            {{ __('Daftar Iklan Like') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('iklan.view.komentar')">
                            {{ __('Daftar Iklan Komentar') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('iklan.view.posting')">
